...
?>		<div class="content">
	...
	{ $count++;
		?>
								...
								<tr>
									<td><label for="name">Complaints</label>
									</td>
								...
								<td></td>
								<td><input   type="submit"  name="publish"   value="Sent Complaint" >
								</td>
      ...
      <?php
			if(isset($_POST['publish']))
			{
				...
				$qry="INSERT INTO `complaint`(`union_id`, `std_id`, `complaint`, `reply`) VALUES ('$union', '$student', '$feed', 'pending')";
