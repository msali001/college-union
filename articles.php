  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		$qry="SELECT a.status,a.article_id,a.type,b.name,b.department,b.year,a.docfile,a.textfile FROM `article` a,`students` b,`union` c where a.student_id=b.student_id and a.union_id=c.union_id and c.`union_id`='$idd' order by a.`article_id` desc "  ;
